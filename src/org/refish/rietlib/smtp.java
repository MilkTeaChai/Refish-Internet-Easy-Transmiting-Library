...
public class smtp {
    public smtp(String ALIDM_SMTP_HOST,String ALIDM_SMTP_PORT,String senderusername,String senderpassword,String geteremail,String title,String msg) {
            // 配置发送邮件的环境属性
            ...
            props.put("mail.user", senderusername);
...
//        mailSession.setDebug(true);
            ...
            try {
                ...
                InternetAddress from = new InternetAddress( senderusername, senderpassword);
                message.setFrom(from);
                //可选。设置回信地址
                Address[] a = new Address[1];
                a[0] = new InternetAddress(senderusername);
                message.setReplyTo(a);
                // 设置收件人邮件地址，比如yyy@yyy.com
                InternetAddress to = new InternetAddress(geteremail);
                ...
                //trace.put("LinkTrace", "1"); //smtp新增点击跟踪
